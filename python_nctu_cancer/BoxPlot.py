#負責DoSurvive當中Normal和Tumor樣本表現量的Box plot繪製
import sys
import traceback
import pandas as pd
import statistics
...
class BoxPlot:
    ...
    def get_mongodb_conn(self):
        ...
        return mongo_db
    #result存放表現量的陣列，並且將數值取Log10取到小數點第三位。
    ...
    #取出目標基因的所有符合癌症的表現量，分為Normal samples和Tumor Samples，最後去取Log

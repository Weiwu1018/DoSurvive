#負責two genes的log-rank test和Km plot
import sys
import traceback
import os
import pandas as pd
...
class TwoGene:
    ...
    def follow_up_threshold(self, df, mode, time):
        ...
        return df
    #logrank計算結果，依據不同的mode (OS, DFI, PFI, DSS)
    ...
    def reset_df(self, df, group1, group2):
        ...
        return df
    #抓出資訊 Ex. Survival type (OS, DFI....), log-rank test p-value, Patient number

...
//Km plot change follow-up threshold
...
/**
 * Show current expression's custom table, prepare to click button and show correlation chart with methylation
 * @param {*} result
 */
